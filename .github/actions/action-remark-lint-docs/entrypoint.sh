...
echo "here"
echo remark --rc-path=/src/remarkrc.suggestion ${INPUT_REMARK_PATHS} ${INPUT_REMARK_ARGS}
remark --rc-path=/src/remarkrc.suggestion ${INPUT_REMARK_PATHS} ${INPUT_REMARK_ARGS}
