...
An incident is anything that compromises — or could compromise — the **Confidentiality,
Integrity, or Availability (CIA)** of CivicActions or client systems and data.
...
Not every incident is security-related; some are just operational (a full disk, a crashed service). We call them security incidents because they _might_ be, and we'd rather find out.
...
After reporting, **follow the Responder's lead** — they may ask you to preserve evidence, provide more detail, or simply stand by.
...
AI has made **spear phishing** - highly personalized attacks that use your name, role, or recent activity - cheap and easy to produce at scale. A message that feels personal and plausible is no longer evidence that it's legitimate.
