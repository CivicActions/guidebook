...
-   Do not use SMS text messages for two-factor authentication. Your TFA is only as strong as the weakest method you have configured.
...
This is the GNU/Linux specific documentation for YubiKey.
...
#### Personalize your YubiKey on MacOS
