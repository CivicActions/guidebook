...
- We use [Zoom](https://zoom.us/) video conferencing software for larger meetings, such as our bi-weekly Bloom Time meetings. To participate, you may download the Zoom app, view in browser, or call in from a telephone (just don't forget to mute yourself!).
- Login with your Bloom Works email. You will see a link below the sign-in box that reads, "Or, sign in with Google..." so click that and proceed to login via your Bloom Works email (may automatically do it if you're already logged in via your browser)
...
Most Bloom Works employees have free Zoom accounts, which have enough features to participate and to host short meetings. Meeting hosts may need paid accounts, because free accounts are limited in two important ways:

- Meetings are limited to 40 minutes.
- No recording is possible.

Paid accounts are available for those who need them regularly (once a week or so, or if you host a regular call that needs Zoom). If you need to host a longer meeting, or you need to record a meeting, you can either ask a project manager or someone you know has a paid account to host it for you, or you can request a paid account via <mailto:admin@bloomworks.digital>.

## Tips and Shortcuts

- Zoom is the default video meeting tool for Bloom Works as it easily allows participants to dial themselves in to the meeting
