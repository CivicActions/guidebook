...
If this is also a security incident, the IC also follows the [security incident assessment](incidents/incident-response-plan.md#4-assess-the-incident) and [remediation](incident-response-plan.md#5-remediate) processes.
