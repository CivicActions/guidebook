...
![PR workflow screenshot 1](../img/01-PR-pull-requests-tab.png)

2. Check to make sure "All checks have passed." If not, ask the person who added the PR to fix any errors.

![PR workflow screenshot 2](../img/02-PR-checks-passed.png)

3. Click "Add your review."

![PR workflow screenshot 3](../img/03-PR-add-review.png)
...
![PR workflow screenshot 4](../img/04-PR-approve.png)

5. Submit your review.

![PR workflow screenshot 5](../img/05-PR-submit-review.png)

6. Merge Pull Request, and you're done!

![PR workflow screenshot 6](../img/06-PR-merge.png)
